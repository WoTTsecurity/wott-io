...
## What are default credentials? <a id="default-credentials"></a>
...
## What is SELinux? <a id="selinux"></a>
...
## What is AppArmor? <a id="apparmor"></a>
...
## What is Firewall Policy? <a id="firewall-policy"></a>
...
## What are open connections? <a id="open-connections"></a>
...
## What is a device certificate? <a id="device-certificate"></a>
...
## What is Device/Node ID? <a id="device-id"></a>
...
## OpenSSH: PerminRootLogin <a id="openssh-permit-root-login"></a>
...
## OpenSSH: AllowAgentForwarding <a id="openssh-allow-agent-forwarding"></a>
...
## OpenSSH: PasswordAuthentication <a id="openssh-password-authentication"></a>
...
## What Operating Systems does the WoTT Agent support? <a id="wott-operating-system"></a>
See [this page](https://github.com/WoTTsecurity/agent#supported-operating-systems) for an up to date list.

## Do I need a WoTT Dashboard account to use the WoTT Agent? <a id="do-i-need-dashboard"></a>
...
## I've installed the WoTT Agent, now what? <a id="steps-after-installation"></a>
...
## Is WoTT Open Source? <a id="wott-open-source"></a>

Yes, the WoTT Agent is licensed under the [MIT License](https://opensource.org/licenses/MIT).

## I'm a developer and want to modify your code/can't run virtualenv <a id="developing-for-wott-language)"></a>
