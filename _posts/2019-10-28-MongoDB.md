...
and change it to <mark>**"endabled"**</mark>. Save the file and start up your mongodb server. Go back to your terminal and access the mongo client, this time adding the following:
