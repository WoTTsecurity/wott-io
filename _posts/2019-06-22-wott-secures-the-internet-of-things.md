...
{% asset blog/why_cant_iot.png srcset:width="1300 2x" srcset:width="650 1x" alt="No Image" %}
...
{% asset blog/use_a_tmp_seriously.png srcset:width="1300 2x" srcset:width="650 1x" alt="No Image" %}
...
{% asset blog/total_trust_score.png srcset:width="1300 2x" srcset:width="650 1x" alt="No Image" %}
